...
export default function ControlsVideo() {
  ...
  const {videoSync, videoRefs, volume, currentTime, markers, updateMarkers, updateVolume, updateVideoSync, updateCurrentTime} = useContext(VideoContext)
  ...
  },[currentTimeProgressBar, videoSync, getCurrentTime, getDuration, markers, selectedMarker, dataX, percentageX]) 

  return (
    <div className="w-[95vw]  my-8 mx-auto">
